...
- DevTools_ShouldFancyText (Whether or not the text that a tool prints out gets formatted into a Lua function. Example: 0 0 0 gets formatted into Vector( 0, 0, 0 ))
